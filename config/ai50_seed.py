...
AI50_SEED: list[AI50SeedEntry] = [
    ...
    {"name": "Cohere",                 "careers_url": "https://cohere.com/careers",           "ats_type": "ashby",      "ats_slug": "cohere"},
    ...
    # v0.1.4: corrected from (ashby, "heygen") — they're on Greenhouse with the
    # same slug (25 active jobs verified).
    {"name": "HeyGen",                 "careers_url": "https://www.heygen.com/careers",       "ats_type": "greenhouse", "ats_slug": "heygen"},
    ...
    # v0.1.4: corrected from (greenhouse, "runway") — actual ATS is Ashby
    # (4 active jobs verified, slim).
    {"name": "Runway",                 "careers_url": "https://runwayml.com/careers",         "ats_type": "ashby",      "ats_slug": "runway"},
    {"name": "Safe Superintelligence", "careers_url": "https://ssi.inc/careers",              "ats_type": "ashby",      "ats_slug": "ssi"},
    # v0.1.3: corrected from (lever, "sambanova") — they're on Greenhouse with
    # slug 'sambanovasystems' (24 active jobs verified).
    {"name": "SambaNova",              "careers_url": "https://sambanova.ai/careers",         "ats_type": "greenhouse", "ats_slug": "sambanovasystems"},
    # Surge AI removed v0.1.4 — they don't expose a discoverable ATS (in-house
    # apply form via careers page, no Greenhouse/Ashby/Lever signals).
    # v0.1.4: corrected from (ashby, "worldlabs") — they're on Greenhouse
    # (12 active jobs verified).
    {"name": "World Labs",             "careers_url": "https://www.worldlabs.ai/careers",     "ats_type": "greenhouse", "ats_slug": "worldlabs"},
    # v0.1.4: corrected from (ashby, "clay") — actual slug is 'claylabs'
    # (76 active jobs verified).
    {"name": "Clay",                   "careers_url": "https://www.clay.com/careers",         "ats_type": "ashby",      "ats_slug": "claylabs"},
]
